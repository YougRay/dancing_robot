...
def talker():
    pub1 = rospy.Publisher('/arm/joint1_position_controller',std_msgs.msg.Float64,queue_size=10)
    pub2 = rospy.Publisher('/arm/joint2_position_controller',std_msgs.msg.Float64,queue_size=10)
    pub5 = rospy.Publisher('/arm/joint5_position_controller',std_msgs.msg.Float64,queue_size=10)
...
def danceFromArray(dArr, space = 2, iter = 1): #of shape n, 2, 3 and has values 0,1,2 for low middle high servos
    ...
    for _ in range(iter):
        for n in range(len(dArr)):
            ...
            #ros
            pub1.publish(std_msgs.Float64(val[0][0])
            pub2.publish(std_msgs.Float64(val[0][1])   
            pub5.publish(std_msgs.Float64(val[0][2])
            ...
            pub1.publish(std_msgs.Float64(0)
            pub2.publish(std_msgs.Float64(0)   
            pub5.publish(std_msgs.Float64(0)
